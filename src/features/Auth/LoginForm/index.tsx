...
function LoginForm({ onFormFinish, onFormFinishFalse, openRegisterForm }: LoginFormProps) {
    return (
        <Form
            name="login"
            labelCol={{ span: 8 }}
        ...
        >
            <div className="form-title">
                ...
                <span className="form-title__sign-up" onClick={openRegisterForm}>Sign Up!</span>
            </div>
            <Form.Item
                name="email"
                rules={[
