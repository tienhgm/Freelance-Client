...
function FindFreelancer() {
  return (
    ...
    //     </div>
    // </div>
    <div className="FindFreelancer flex flex-col find-job-page sm:flex-row">
      <div className="FindFreelancer__sidebar flex-shrink-0 overflow-y-auto p-8 pb-0 w-52 md:w-60 lg:w-80">
        <Sidebar />
      </div>
      <div className="w-full overflow-y-auto p-8 FindFreelancer__list">
